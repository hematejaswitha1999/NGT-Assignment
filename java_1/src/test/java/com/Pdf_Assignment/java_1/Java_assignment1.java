package com.Pdf_Assignment.java_1;
...
public class Java_assignment1 {
	@Test(priority=1)
	public void pdfFileFromSystem() throws IOException {
		File file = new File("C:/Users/HNARAVA/Desktop/SaurabhSingh.pdf");
	...
	@Test(priority=2)
	public void ReadPDFFileFromInternet() throws IOException {
